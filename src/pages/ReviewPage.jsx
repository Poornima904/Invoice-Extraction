    ...
    <div className="flex bg-gray-50 h-[calc(100vh-53px)] w-full overflow-hidden">
      <div className="flex flex-col flex-1">
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden">
          ...
          {/* Left Panel */}
          <div className="flex-[3] bg-gray-100 min-w-[400px] max-w-[700px] border-r flex flex-col">
            ...
            <div className="flex-1 overflow-auto px-3 flex items-start justify-center">
              <img src={invoiceImage} alt="Invoice" className="rounded-lg border shadow max-w-full h-auto" />
            </div>

            {/* Confidence legend */}
            <div className="bg-gray-100 py-3 px-6 border-t border-gray-200 flex gap-6 text-xs justify-center flex-shrink-0">
              <span className="flex items-center gap-1 text-green-700">
                <span className="w-3 h-3 rounded bg-green-100 inline-block"></span> High confidence (90%+)
              </span>
              <span className="flex items-center gap-1 text-orange-500">
                <span className="w-3 h-3 rounded bg-orange-100 inline-block"></span> Medium confidence (70-89%)
              </span>
              <span className="flex items-center gap-1 text-red-600">
                <span className="w-3 h-3 rounded bg-red-100 inline-block"></span> Low confidence (&lt;70%)
              </span>
            </div>
          </div>
          ...
          <div className="flex-[3.7] flex flex-col h-full bg-gray-50 min-w-[440px] max-w-[740px] border-l">
            ...
            <div className="sticky top-0 z-30 bg-white px-10 py-5 flex items-center justify-between">
            ...
            <div className="sticky bottom-0 left-0 right-0 w-full bg-white border-t px-10 py-5 flex justify-end gap-3 z-30">
              <button className="px-5 py-2 rounded bg-gray-200 font-semibold hover:bg-gray-300">Reject Invoice</button>
              <button className="px-5 py-2 rounded bg-gray-100 font-semibold hover:bg-gray-200">Save Draft</button>
              <button className="px-5 py-2 rounded bg-gradient-to-r from-green-400 to-blue-500 text-white font-semibold">Approve &amp; Process</button>
            </div>
          </div>
        </div>
      </div>
